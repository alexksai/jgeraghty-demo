...
export default function Home(){
  return <main>
    ...
    <section className="intro"><div><span>01 / Our Services</span><h2>EVERY SERVICE.<br/>ONE TEAM.</h2></div><p>One experienced team managing utility infrastructure and connections from planning through delivery.</p></section>
